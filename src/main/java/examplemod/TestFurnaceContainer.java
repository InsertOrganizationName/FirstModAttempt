...
public class TestFurnaceContainer extends Container {
    ...
    private TestFurnaceTileEntity tileInventoryFurnace;
    ...
    public TestFurnaceContainer(InventoryPlayer invPlayer, TestFurnaceTileEntity tileInventoryFurnace) {
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int sourceSlotIndex)
    {
        ...
        if (sourceSlotIndex >= VANILLA_FIRST_SLOT_INDEX && sourceSlotIndex < VANILLA_FIRST_SLOT_INDEX + VANILLA_SLOT_COUNT) {
            ...
            if (TestFurnaceTileEntity.getSmeltingResultForItem(sourceStack) != null){
                if (!mergeItemStack(sourceStack, FIRST_INPUT_SLOT_INDEX, FIRST_INPUT_SLOT_INDEX + INPUT_SLOTS_COUNT, false)){
                    return null;
                }
            }	else if (TestFurnaceTileEntity.getItemBurnTime(sourceStack) > 0) {
...
//                    listener.sendProgressBarUpdate(this, fieldID, cachedFields[fieldID]);
    ...
    public class SlotFuel extends Slot {
        ...
        public boolean isItemValid(ItemStack stack) {
            return TestFurnaceTileEntity.isItemValidForFuelSlot(stack);
        }
    }
    ...
    public class SlotSmeltableInput extends Slot {
        ...
        @Override
        public boolean isItemValid(ItemStack stack) {
            return TestFurnaceTileEntity.isItemValidForInputSlot(stack);
        }
    }
    ...
    public class SlotOutput extends Slot {
        ...
        @Override
        public boolean isItemValid(ItemStack stack) {
            return TestFurnaceTileEntity.isItemValidForOutputSlot(stack);
        }
    }
}
